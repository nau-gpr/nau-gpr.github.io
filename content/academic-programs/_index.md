...
- block: markdown
  content:
    ...
    text: |
      ...
      <div class="row">
        <div class="col-md-6">
          <img src="degrees-featured.jpg" alt="Degree Programs" class="img-fluid mb-3">
          ...
          <p><a href="undergraduate-degrees/" class="btn btn-primary">Learn More About Undergraduate Programs</a></p>
        </div>
        <div class="col-md-6">
          <img src="graduate-featured.jpg" alt="Graduate Programs" class="img-fluid mb-3">
          ...
          <p><a href="graduate-degrees/" class="btn btn-primary">Learn More About Graduate Programs</a></p>
        </div>
      </div>
  design:
    columns: 1
    ...
    text: |
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p><a href="https://in.nau.edu/department-geography-planning-recreation/home/degrees-programs/graduate-degrees-certificates/community-planning-graduate-certificate/" class="btn btn-primary">Learn More About this Graduate Certificate</a></p>
        </div>
      </div>
  design:
    columns: 1
